  ...
  return (
    ...
    <div className="parent">
      {jobOpenings.map( (elem) => {
       return (
        <Cards logo={elem.brandLogo} company={elem.companyName} date={elem.datePosted} post={elem.post} tag1={elem.tag1} tag2={elem.tag2} pay={elem.pay} location={elem.location}/>
       )
      })}
